...
metric_defaults = EasyDict([(args.name, args) for args in [
    ...
    EasyDict(name='lpips', func_name='metrics.perceptual_patch_similarity.LPIPS',     num_samples=50000, epsilon=1e-4, space='z', sampling='full', crop=True, minibatch_per_gpu=4, Gs_overrides=dict(dtype='float32', mapping_dtype='float32')),
    EasyDict(name='ppgs', func_name='metrics.perceptual_path_sparsity.PPGS',     num_samples=50000, epsilon=1e-4, space='z', sampling='full', crop=True, minibatch_per_gpu=4, Gs_overrides=dict(dtype='float32', mapping_dtype='float32')),
