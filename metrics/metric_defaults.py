...
metric_defaults = EasyDict([(args.name, args) for args in [
    ...
    EasyDict(name='cas1k',     func_name='metrics.classification_acc.CAS',         num_images=1000, minibatch_per_gpu=8),
    EasyDict(name='cas10k',     func_name='metrics.classification_acc.CAS',         num_images=10000, minibatch_per_gpu=8),
