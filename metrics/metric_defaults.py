...
metric_defaults = EasyDict([(args.name, args) for args in [
    ...
    EasyDict(name='lpips', func_name='metrics.perceptual_patch_similarity.LPIPS',     num_samples=50, epsilon=1e-4, space='z', sampling='full', crop=True, minibatch_per_gpu=4, Gs_overrides=dict(dtype='float32', mapping_dtype='float32')),
